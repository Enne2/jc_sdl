...
> **Note:** You must install SDL 1.2 development libraries to build.
> On Debian/Ubuntu: `sudo apt-get install libsdl1.2-dev`
> On Fedora: `sudo dnf install SDL-devel`

**Status:** Verified. The project compiles and runs on Linux with SDL 1.2.
